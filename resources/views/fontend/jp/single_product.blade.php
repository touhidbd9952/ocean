    ...
    <div class="shell">
      <div class="tabs-custom tabs-custom-init tabs-inline" id="tabs-production">
        ...
        <div class="section__header">
          <h4 style="color:#F5A64E;font-weight:bold;">Auction No.:{{$products[0]->product_no}}</h4>
              ...
              {{-- <div class="layout-horizontal__aside">
                <div class="slick-slider-vertical">
                  <div class="slick-slider carousel-parent" id="parent-carousel-1" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-child="#child-carousel-1" data-for="#child-carousel-1">
                    ...
                    @foreach($products as $p)
                      <div class="item">
                        <div class="slick-image" style="border: 1px solid #F5A64E;">
                          <img src="{{ asset($p->thumbnail_image) }}" alt="" width="640" height="480"/>
                        </div>
                      </div>
                    @endforeach
                    ...
                    @foreach($product_multiple_images as $pimages)
                      <div class="item">
                        <div class="slick-image">
                          <img src="{{ asset($pimages->image) }}" alt="" width="640" height="480"/>
                        </div>
                      </div>
                    @endforeach
                    ...
                    @foreach($product_multiple_videos as $pvideo)
                      <div class="item">
                        <div class="slick-image">
                          <video width="575" height="480" controls  style="margin-top: -80px;">
              ...
              <div class="col-md-6 mobp">
                <table>
                  <tbody>
                    ...
                    <form action="{{route('auction.bidforthis',[$products[0]['id']])}}" method="post"  style="padding-left: 5px;float: right;">
                    ...
                    <tr>
                      ...
                      <td valign="center" align="center" class="bidtimeleft" colspan="3" style="padding-top: 15px;">
                        ...
                        <span id="bidbutton{{$products[0]['id']}}">
                          ...
                          ?>
                          <input type="submit"  value="Bid" class="button bid" style="padding: 0px 0px !important;margin-top: 0px;">
