				...
				<div class="col-md-8">
                    <div class="box row">
                      ...
                      <div class="col-md-10" style="text-align: center;">
                          ...
                          <form  action="{{route('job_provider.registration_store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <textarea  name="address" class="form-control @error('address') is-invalid @enderror" tabindex="4"></textarea>
                                  @error('address')
                                      <span class="text-danger"> {{$message}}  </span>
                                  @enderror
                              </div>
